...
var config = {
  apiOrigins: {
    ...
    production: 'https://mels-fullstack-project.herokuapp.com'
  }
};
...
var trailEvents = __webpack_require__(16);
...
var createTrailSuccess = function createTrailSuccess(data) {
  store.trail = data.trail;
};

var createTrailFailure = function createTrailFailure() {
  $('#message').show();
...
module.exports = {
  ...
  createTrailSuccess: createTrailSuccess,
  createTrailFailure: createTrailFailure
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
...
var getFormFields = __webpack_require__(6);
var trailsApi = __webpack_require__(17);
var trailsUi = __webpack_require__(18);
var store = __webpack_require__(3);

var addTrail = function addTrail(event) {
  event.preventDefault();
  var data = getFormFields(this);
  trailsApi.createTrail(data).then(trailsUi.addTrailSuccess).catch(trailsUi.addTrailFailure);
  $('#trail-list').show();
  $('#update-trail-div').hide();
};

var addTrailDisplay = function addTrailDisplay() {
  $('#add-trail-div').show();
  $('#add-trail-button').hide();
  $('#update-trail-div').hide();
...
var viewTrails = function viewTrails(event) {
  event.preventDefault();
  trailsApi.getTrails().then(trailsUi.getTrailsSuccess).then(deleteTrail).then(editTrail).then(updateTrail).catch(trailsUi.getTrailsFailure);
  $('#trail-list').show();
};

var deleteTrail = function deleteTrail() {
  $('.remove').on('click', function (event) {
    var index = $(event.target).attr('data-id');
    trailsApi.deleteTrail(index).then(trailsUi.deleteTrailSuccess).then(function () {
      $(event.target).parent().parent().hide();
    }).catch(trailsUi.deleteTrailFailure);
  });
};

var editTrail = function editTrail() {
  $('.edit').on('click', function (event) {
    $('#add-trail-div').hide();
    $('#add-trail-button').show();
    var index = $(event.target).attr('data-id');
    trailsApi.getTrail(index).then(function (data) {
      var mountainName = data.trail.mountain_name;
      var trailName = data.trail.trail_name;
      var difficulty = data.trail.difficulty;
      var rating = data.trail.rating;
      var id = data.trail.id;
...
var updateTrail = function updateTrail() {
  $('#update-trail').on('submit', function (event) {
    event.preventDefault();
    var data = getFormFields(this);
    trailsApi.updateTrail(data, store.trailId).then(trailsUi.updateTrailSuccess).catch(trailsUi.updateTrailFailure);
    $('#trail-list').show();
  });
};

var searchTrails = function searchTrails(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  trailsApi.searchTrails(data.trail.rating).then(trailsUi.searchTrailsSuccess).then(deleteTrail).then(editTrail).then(updateTrail).catch(trailsUi.searchTrailsFailure);
};
...
var createTrail = function createTrail(data) {
  return $.ajax({
...
var getTrail = function getTrail(id) {
  return $.ajax({
...
var updateTrail = function updateTrail(data, trailId) {
  return $.ajax({
...
var deleteTrail = function deleteTrail(data) {
  return $.ajax({
...
var searchTrails = function searchTrails(data) {
  return $.ajax({
...
var showTrailsTemplate = __webpack_require__(19);

var addTrailSuccess = function addTrailSuccess(data) {
  $('#add-message').show();
...
var addTrailFailure = function addTrailFailure() {
  $('#message').show();
  $('#message').text('Add trail failed :(');
};

var getTrailsSuccess = function getTrailsSuccess(data) {
  var showTrailsHtml = showTrailsTemplate({ trails: data.trails });
  $('#trail-list').empty();
  $('#view-trails').hide();
...
var searchTrailsSuccess = function searchTrailsSuccess(data) {
  var showTrailsHtml = showTrailsTemplate({ trails: data.trails });
  $('#trail-list').empty();
  $('#trail-list').show();
  $('#view-trails').show();
...
var searchTrailsFailure = function searchTrailsFailure() {
  $('#message').show();
  $('#message').text('Sorry there was an issue searching for your trails');
};

var getTrailsFailure = function getTrailsFailure() {
  $('#message').show();
  $('#message').text('Sorry there was an issue getting your saved trails');
};

var deleteTrailSuccess = function deleteTrailSuccess() {
  $('#message').show();
...
var deleteTrailFailure = function deleteTrailFailure() {
  $('#message').show();
  $('#message').text('Sorry, there was an issue deleting your trail');
};

var updateTrailSuccess = function updateTrailSuccess() {
  $('#update-message').show();
...
var updateTrailFailure = function updateTrailFailure() {
  $('#message').show();
  $('#message').text('Sorry, there was an issue updating your trail');
};

module.exports = {
  addTrailSuccess: addTrailSuccess,
  addTrailFailure: addTrailFailure,
  getTrailsSuccess: getTrailsSuccess,
  getTrailsFailure: getTrailsFailure,
  deleteTrailSuccess: deleteTrailSuccess,
  deleteTrailFailure: deleteTrailFailure,
  updateTrailSuccess: updateTrailSuccess,
  updateTrailFailure: updateTrailFailure,
  searchTrailsSuccess: searchTrailsSuccess,
  searchTrailsFailure: searchTrailsFailure
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "<!-- go through trails array and do something on each one -->\n        <div class=\"row\">\n        <div class=\"col-xs-2\">"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.trail_name : stack1), depth0))
    + "</div>\n        <div class=\"col-xs-2\">"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.mountain_name : stack1), depth0))
    + "</div>\n        <div class=\"col-xs-2\">"
    ...
    + "</div>\n        <div class=\"col-xs-2\" ><button data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\" type=\"button\" class=\"remove\">Remove!</button></div>\n        <div class=\"col-xs-2\"><button data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\"type=\"button\" class=\"edit\">Edit</button></div>\n        </div>\n\n";
},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1;

  return "\n      <div class=\"row trails-header\">\n        <div class=\"col-xs-2 list-header\">Trail</div>\n        <div class=\"col-xs-2 list-header\">Mountain</div>\n        <div class=\"col-xs-2 list-header\">Difficulty</div>\n        <div class=\"col-xs-2 list-header\">Rating</div>\n        <div class=\"col-xs-2 list-header\">Remove</div>\n        <div class=\"col-xs-2 list-header\">Edit</div>\n      </div>\n      <hr style=\"margin-bottom:5px !important; margin-top:5px !important;\">\n\n\n"
    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.trails : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
